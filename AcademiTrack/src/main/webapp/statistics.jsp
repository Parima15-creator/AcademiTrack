...
<div class="main">
    ...
    <div class="class-buttons" id="classGroup">
        ...
        <button onclick="selectClass(this, 'SE2')">TE Comp 1</button>
        <button onclick="selectClass(this, 'SE2')">TE Comp 2</button>
        <button onclick="selectClass(this, 'SE2')">BE Comp 1</button>
    ...
    <div id="semSection" style="display: none; margin-top: 20px;">
        ...
        <div class="class-buttons" id="semGroup">
            ...
            <button onclick="selectSemester(this, '4')">Sem 5</button>
            <button onclick="selectSemester(this, '4')">Sem 6</button>
            <button onclick="selectSemester(this, '4')">Sem 7</button>
